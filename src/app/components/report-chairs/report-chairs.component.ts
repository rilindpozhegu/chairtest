...
@Component({
  selector: 'app-report-chairs',
  templateUrl: './report-chairs.component.html',
  styleUrls: ['./report-chairs.component.css']
})
export class ReportChairsComponent implements OnInit {
  ...
  getKlasatFromFloor(floorNumber, refreshClass:boolean) {
    this.chosenFloor = floorNumber;
      ...
      this._klasService.getAllFloorKlasat(floorNumber).subscribe(
        res => {
          console.log(res);
          this.klasat = res[0];
